...
public class Alchemy implements WurmServerMod, Initable, PreInitable, Configurable, ItemTemplatesCreatedListener,
        ServerStartedListener, ServerPollListener, PlayerMessageListener, PlayerLoginListener {
    ...
    public void configure(Properties properties) {
        ...
        // Config.worldMaxX = Integer.parseInt(properties.getProperty("worldMaxX",
        // "4096"));
        // Config.worldMaxY = Integer.parseInt(properties.getProperty("worldMaxY",
        // "4096"));
    ...
    public void onServerPoll() {
        try {
            ...
            if (!ModSupportDb.hasTable(dbconn, "Alchemy_OiledWeapons") && !finishedDbReadingEnchantments
                    && !finishedDbReadingAddictions) {
                // table create
                try (PreparedStatement ps = dbconn.prepareStatement(
                        "CREATE TABLE Alchemy_OiledWeapons (itemId LONG PRIMARY KEY NOT NULL DEFAULT 0, playerId LONG NOT NULL "
                                + "DEFAULT 0 "
                ...
                try (PreparedStatement ps = dbconn.prepareStatement(
                        "CREATE TABLE Alchemy_Addictions (playerId LONG PRIMARY KEY NOT NULL DEFAULT 0, currentAddiction INTEGER NOT NULL "
