...
public class AlchItems {
	...
	private static void registerLeader() throws IOException {
		leader = new ItemTemplateBuilder("arathok.alchemy.leader")
				...
				}).decayTime(9072000L).dimensions(8, 8, 15).weightGrams(85000).material(Materials.MATERIAL_IRON)
	...
	private static void registerGlassMixture() throws IOException {
		glassMixture = new ItemTemplateBuilder("arathok.alchemy.glassMixture").name("glass mixture", "glass mixtures",
				...
				.modelName("model.decoration.glasMixture.").imageNumber((short) IconConstants.ICON_MORTAR_PILE)
				.itemTypes(new short[] {
				...
				}).decayTime(9072000L).dimensions(20, 20, 20).weightGrams(24000).material(Materials.MATERIAL_IRON)
	...
	private static void registerMouldClay() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.POTTERY, ItemList.flaskPottery, ItemList.clay, mouldClayId,
	...
	private static void registerMouldPottery() throws IOException {
		mouldPottery = new ItemTemplateBuilder("arathok.alchemy.mouldPottery")
				...
				.itemTypes(new short[] { ItemTypes.ITEM_TYPE_POTTERY, ItemTypes.ITEM_TYPE_PLANTABLE,
						...
						// ItemTypes.ITEM_TYPE_TRANSPORTABLE,
						ItemTypes.ITEM_TYPE_TOOL, ItemTypes.ITEM_TYPE_METAL, })
				.decayTime(9072000L).dimensions(8, 8, 15).weightGrams(500).material(Materials.MATERIAL_IRON)
				.behaviourType((short) 1).primarySkill(SkillList.POTTERY).difficulty(30) // no hard lock
				.build();
	...
	private static void registerPhial() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.ALCHEMY_NATURAL, AlchItems.mouldPotteryId, AlchItems.glassId,
				phialId, false, true, 0f, false, false, CreationCategories.DECORATION);
	...
	private static void registerAlchemicalCompound() throws IOException {
		alchemicalCompound = new ItemTemplateBuilder("arathok.alchemy.alchemicalCompound")
				...
				.itemTypes(
						new short[] { ItemTypes.ITEM_TYPE_BULK, ItemTypes.ITEM_TYPE_LIQUID, ItemTypes.ITEM_TYPE_METAL,
	...
	private static void registermixtureDodging() throws IOException {
		mixtureWillowspine = new ItemTemplateBuilder("arathok.alchemy.mixtureDodge").name("mixture of shadow",
				"mixtures of shadow",
	...
	private static void registermixtureOakshell() throws IOException {
		mixtureOakshell = new ItemTemplateBuilder("arathok.alchemy.mixtureOakshell")
				...
				.behaviourType((short) 1).primarySkill(SkillList.ALCHEMY_NATURAL).difficulty(50) // no hard lock
				.build();
	...
	private static void registermixtureStrength() throws IOException {
		mixtureStrength = new ItemTemplateBuilder("arathok.alchemy.mixture")
				...
				.behaviourType((short) 1).primarySkill(SkillList.ALCHEMY_NATURAL).difficulty(40) // no hard lock
				.build();

		mixtureStrengthId = mixtureStrength.getTemplateId();

		CreationEntryCreator
				.createAdvancedEntry(SkillList.ALCHEMY_NATURAL, ItemList.mushroomBlack, ItemList.paprika,
						mixtureStrengthId, true, true, 0f, true, false, CreationCategories.ALCHEMY)
	...
	private static void registermixtureVyn() throws IOException {
		mixtureVynora = new ItemTemplateBuilder("arathok.alchemy.mixtureVyn").name("mixture of Knowledge",
				...
				.itemTypes(new short[] { ItemTypes.ITEM_TYPE_BULK, ItemTypes.ITEM_TYPE_HERB,
						...
						ItemTypes.ITEM_TYPE_REPAIRABLE, })
				.decayTime(9072000L).dimensions(3, 3, 3).weightGrams(100).material(Materials.MATERIAL_MAGIC)
				.behaviourType((short) 1).primarySkill(SkillList.ALCHEMY_NATURAL).difficulty(90) // no hard lock
				.build();
	...
	private static void registerPrecursorDodge() throws IOException {
		precursorWillowspine = new ItemTemplateBuilder("arathok.alchemy.precursorDodge")
				.name("potion precursor of shadow", "precursors of shadow",
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureWillowspineId, precursorWillowspineId, true, true, 0f, false, false,
	...
	private static void registerPrecursorExcell() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureExcellId, precursorExcellId, true, true, 0f, false, false,
	...
	private static void registerPrecursorGoat() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureGoatId, precursorGoatId, true, true, 0f, false, false, CreationCategories.DECORATION);
	}
	...
	private static void registerPrecursorHeal() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureHealId, precursorHealId, true, true, 0f, false, false, CreationCategories.DECORATION);
	}
	...
	private static void registerPrecursorFranticCharge() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureFranticChargeId, precursorFranticChargeId, true, true, 0f, false, false,
				CreationCategories.DECORATION);
	}
	...
	private static void registerPrecursorMorningFog() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureMorningFogId, precursorMorningFogId, true, true, 0f, false, false,
				CreationCategories.DECORATION);
	}
	...
	private static void registerPrecursorOakshell() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureOakshellId, precursorOakshellId, true, true, 0f, false, false,
				CreationCategories.DECORATION);
	}
	...
	private static void registerPrecursorRefresh() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureRefreshId, precursorRefreshId, true, true, 0f, false, false,
				CreationCategories.DECORATION);
	}
	...
	private static void registerPrecursorSixthSense() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureSixthSenseId, precursorSixthSenseId, true, true, 0f, false, false,
				CreationCategories.DECORATION);
	}
	...
	private static void registerPrecursorStrength() throws IOException {
		precursorStrength = new ItemTemplateBuilder("arathok.alchemy.precursorStrength")
				.name("potion precursor of strength", "precursors of strength",
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureStrengthId, precursorStrengthId, true, true, 0f, false, false,
				CreationCategories.DECORATION);
	}
	...
	private static void registerPrecursorTruehit() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureTruehitId, precursorTruehitId, true, true, 0f, false, false,
				CreationCategories.DECORATION);
	}
	...
	private static void registerPrecursorVynora() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.alchemicalCompoundId,
				AlchItems.mixtureVynoraId, precursorVynoraId, true, true, 0f, false, false,
				CreationCategories.DECORATION);
	}
	...
	private static void registerPotionLiquidDodge() throws IOException {
		potionLiquidWillowspine = new ItemTemplateBuilder("arathok.alchemy.potionLiquidDodge").name(
				" potion liquid of shadow", "potion liquids of shadow",
	...
	private static void registerPotionLiquidStrength() throws IOException {
		potionLiquidStrength = new ItemTemplateBuilder("arathok.alchemy.potionLiquidStrength").name(
				" potion liquid of strength", "potion liquids of strength",
	...
	private static void registerPotionLiquidVynora() throws IOException {
		potionLiquidVynora = new ItemTemplateBuilder("arathok.alchemy.potionLiquidVynora").name(
				" potionLiquid of vynora", "potionLiquids of vynora",
	...
	private static void registerPotionDodge() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId,
				AlchItems.potionLiquidWillowspineId, potionIdWillowspine, true, true, 0f, false, false,
				CreationCategories.ALCHEMY);
	}
	...
	private static void registerPotionExcell() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId,
				AlchItems.potionLiquidExcellId, potionIdExcell, true, true, 0f, false, false,
				CreationCategories.ALCHEMY);
	}
	...
	private static void registerPotionGoat() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId, AlchItems.potionLiquidGoatId,
	...
	private static void registerPotionHeal() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId, AlchItems.potionLiquidHealId,
	...
	private static void registerPotionFrenzy() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId,
				AlchItems.potionLiquidFranticChargeId, potionIdFranticCharge, true, true, 0f, false, false,
				CreationCategories.ALCHEMY);
	}
	...
	private static void registerPotionMorningFog() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId,
				AlchItems.potionLiquidMorningFogId, potionIdMorningFog, true, true, 0f, false, false,
				CreationCategories.ALCHEMY);
	}
	...
	private static void registerPotionOakshell() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId,
				AlchItems.potionLiquidOakshellId, potionIdOakshell, true, true, 0f, false, false,
				CreationCategories.ALCHEMY);
	}
	...
	private static void registerPotionRefresh() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId,
				AlchItems.potionLiquidRefreshId, potionIdRefresh, true, true, 0f, false, false,
				CreationCategories.ALCHEMY);
	}
	...
	private static void registerPotionSixthSense() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId,
				AlchItems.potionLiquidSixthSenseId, potionIdSixthSense, true, true, 0f, false, false,
				CreationCategories.ALCHEMY);
	}
	...
	private static void registerPotionStrength() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId,
				AlchItems.potionLiquidStrengthId, potionIdStrength, true, true, 0f, false, false,
				CreationCategories.ALCHEMY);
	}
	...
	private static void registerPotionTruehit() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId,
				AlchItems.potionLiquidTruehitId, potionIdTruehit, true, true, 0f, false, false,
				CreationCategories.ALCHEMY);
	}
	...
	private static void registerPotionVynora() throws IOException {
		potionVynora = new ItemTemplateBuilder("arathok.alchemy.potionVynora")
				...
				.behaviourType((short) 1).primarySkill(SkillList.GROUP_ALCHEMY).difficulty(90) // no hard lock
				.build();

		potionIdVynora = potionVynora.getTemplateId();
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, AlchItems.phialId,
				AlchItems.potionLiquidVynoraId, potionIdVynora, true, true, 0f, false, false,
				CreationCategories.ALCHEMY);
	}
	...
	public static void register() throws IOException {
		...
		registerGlass();
		TempStates
				.addState(new TempState(AlchItems.glassMixtureId, AlchItems.glassId, (short) 4000, true, false, false));
		registerMouldClay();
		registerMouldPottery();
		TempStates.addState(
				new TempState(AlchItems.mouldClayId, AlchItems.mouldPotteryId, (short) 4000, true, true, false));
		registerPhial();
		...
		TempStates.addState(new TempState(AlchItems.precursorExcellId, AlchItems.potionLiquidExcellId, (short) 4000,
				true, true, false));
		TempStates.addState(new TempState(AlchItems.precursorFranticChargeId, AlchItems.potionLiquidFranticChargeId,
				(short) 4000, true, true, false));
		TempStates.addState(new TempState(AlchItems.precursorGoatId, AlchItems.potionLiquidGoatId, (short) 4000, true,
				true, false));
		TempStates.addState(new TempState(AlchItems.precursorHealId, AlchItems.potionLiquidHealId, (short) 4000, true,
				true, false));
		TempStates.addState(new TempState(AlchItems.precursorMorningFogId, AlchItems.potionLiquidMorningFogId,
				(short) 4000, true, true, false));
		TempStates.addState(new TempState(AlchItems.precursorOakshellId, AlchItems.potionLiquidOakshellId, (short) 4000,
				true, true, false));
		TempStates.addState(new TempState(AlchItems.precursorRefreshId, AlchItems.potionLiquidRefreshId, (short) 4000,
				true, true, false));
		TempStates.addState(new TempState(AlchItems.precursorTruehitId, AlchItems.potionLiquidTruehitId, (short) 4000,
				true, true, false));
		TempStates.addState(new TempState(AlchItems.precursorSixthSenseId, AlchItems.potionLiquidSixthSenseId,
				(short) 4000, true, true, false));
		TempStates.addState(new TempState(AlchItems.precursorStrengthId, AlchItems.potionLiquidStrengthId, (short) 4000,
				true, true, false));
		TempStates.addState(new TempState(AlchItems.precursorVynoraId, AlchItems.potionLiquidVynoraId, (short) 4000,
				true, true, false));
		TempStates.addState(new TempState(AlchItems.precursorWillowspineId, AlchItems.potionLiquidWillowspineId,
				(short) 4000, true, true, false));
