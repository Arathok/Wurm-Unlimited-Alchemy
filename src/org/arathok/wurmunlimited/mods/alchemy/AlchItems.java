...
public class AlchItems {
	...
	private static void registerCharcoalDust() throws IOException {
		...
		CreationEntryCreator.createSimpleEntry(SkillList.GROUP_ALCHEMY, ItemList.grindstone, ItemList.charcoal, coalDustId,true, false, 0.0f, false, false, CreationCategories.ALCHEMY);
	}
